...
namespace Common
{
    internal class ActionsHandler
    {
        ...
        internal void AutoMapColumnsAction<T>(string prefix, params Expression<Func<T, object>>[] ignorePropertyExpressions)
        {
            ...
            {
                var ignoreProperty = ignorePropertyNames.SingleOrDefault(x => x.Equals(string.Concat(prefix, property.Value.Name), StringComparison.CurrentCultureIgnoreCase) || x.Equals(property.Value.Name, StringComparison.CurrentCultureIgnoreCase));
                ...
                ColumnAction(string.Concat(prefix, property.Value.Name), propertyValue, propertyType, DataTypes.Object, 0);
            }
        }
    ...
    {
        BuilderData Data { get; }
        IStoredProcedureBuilder<T> AutoMap(string prefix, params Expression<Func<T, object>>[] ignoreProperties);
    ...
    internal class StoredProcedureBuilder<T> : BaseStoredProcedureBuilder, IStoredProcedureBuilder<T>
    {
        ...
        public IStoredProcedureBuilder<T> AutoMap(string prefix, params Expression<Func<T, object>>[] ignoreProperties)
        {
            Actions.AutoMapColumnsAction(prefix, ignoreProperties);
            return this;
        }
